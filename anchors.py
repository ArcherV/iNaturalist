...
def generate_default_anchor_maps(anchors_setting=None, input_size=(448, 448)):
    """
    generate default anchor

    :param anchors_setting: all informations of anchors
    :param input_size: shape of input images, e.g. (h, w)
    ...
    for anchor_info in anchors_setting:
        ...
        output_map_shape = np.ceil(input_size.astype(np.float32) / stride)

...
class attention_net(nn.Module):
    def __init__(self, input_size, topN=4, CAT_NUM=4, classes=1000):
        ...
        _, edge_anchors, _ = generate_default_anchor_maps(input_size=input_size)
        self.pad_size = 224
    ...
    def forward(self, x):
        ...
        x_pad = F.pad(x, [self.pad_size] * 4, mode='constant', value=0)
        batch = x.size(0)
...
if __name__ == '__main__':
    model = attention_net((448, 448), classes=1010).cuda()
